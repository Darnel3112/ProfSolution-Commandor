#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	Функция СведенияОВнешнейОбработке() Экспорт
		...
		ПараметрыРегистрации.Вставить("Наименование", "Печать этикеток");
		...
		ПараметрыРегистрации.Вставить("Информация", "Внешняя печатная форма печать этикеток");
		...
		ДобавитьКоманду(ТаблицаКоманд, "Печать этикеток", "ПечатьЭтикеток", "ВызовКлиентскогоМетода", Истина, "ПечатьMXL");
