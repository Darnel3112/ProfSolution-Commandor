...
Процедура Печать(МассивОбъектов,  КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если Не ПродолжатьПечать(МассивОбъектов) Тогда
		Сообщение = "Нельзя производить печать накладной М-15 на перемещение где цель отличная от ""Передача оборудования в монтаж"""; 
		ВызватьИсключение Сообщение;
	КонецЕсли;
	
	КоллекцияПечатныхФорм[0].Экземпляров = 1;
	УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм,
	"ПЕРЕМЕЩЕНИЕАКТИВОВПОФОРМЕМ_15",
	НСтр("ru = 'Перемещение активов по форме М-15'"),
...
Функция СформироватьПечатнуюФорму(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПФ_MXL_М15";
...
Функция СведенияОВнешнейОбработке() Экспорт
		...
		ПараметрыРегистрации.Вставить("Наименование", "Пермещение активов М-15");
		...
		ПараметрыРегистрации.Вставить("Информация", "Пермещение активов М-15");
		...
		ДобавитьКоманду(ТаблицаКоманд, "Пермещение активов М-15", "ПЕРЕМЕЩЕНИЕАКТИВОВПОФОРМЕМ_15", "ВызовСерверногоМетода", Истина, "ПечатьMXL");
